                    ...
                    do j=1,i
                      ...
                      do k=1,orb%occ(k0)
                        do l=1,k
                          ...
                          ! write(6,*)"KKKKKKKKKKKK",U(7,7,1,1)
                          ! write(6,*)"JJJJJJJJJJJJJJJ",i1,j1,k1,l1 
                          if(if_2nd_trans)then
                            d2=U2nd(i1,j1,k1,l1)
                          else
                            ! write(6,*)"JJJJJJJJJJJJJJJ",i2,j2,k2,l2
                            ! write(6,*)"",SHAPE(U)
                            d2=U(i2,j2,k2,l2)
                            ! write(6,*)"",d2
                          end if
              ...
              do i1=1,orb%occ(i)
                do i2=1,i1
                  if(if_2nd_trans)then
                    ...
                    write(6,*)T(ioffset+i1,ioffset+i2),ioffset1+i1,ioffset1+i2,0,0

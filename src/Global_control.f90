...
! May affact some shell commands
      character*64 Linux
      CHARACTER(len=255)::Cworkdir
      CHARACTER(len=255)::Cworkdir1
      CHARACTER(len=255)::Cworkdir2

      character*255 FCIDUMP
...
! DMRG control 
      character*255 dmrg_binary_name
      character*255 dmrg_input_name
      character*255 dmrg_input_deri
      character*255 dmrg_rdm1_name
      character*255 dmrg_rdm2_name
      character*255 dmrg_reorder_name
      character*255 dmrg_output_name
      logical ifmpirun
      ...
      character*255 dmrg_inputs(99) 
      character*255 dmrg_inputs_TDM(99) 
      character*255 dmrg_outputs(99)

! DMRG-LR control (Coupled Pertubation)
      logical DMRG_SCF  
      logical DMRG_LAG
      logical  CKP_LR, LRsign, LRirreps
      double precision signtdm,thresMPSHami

...
!  Matrix multi Matrix
      Subroutine MXM(n,M1,M2,M3)
        ...
        write(6,*)"Entering MXM",n;call flush(6)          
        M3=0.0d0

!        call print_mat(n,n,M1,6)
!        write(6,*)"M1/M2";call flush(6)
!        call print_mat(n,n,M2,6)
!        write(6,*)"M2/M3";call flush(6)
!        call print_mat(n,n,M3,6)
!        write(6,*)"M3/MXM";call flush(6)

        call dgemm("N","N",n,n,n,1.0d0,M1,n,M2,n,0.0d0,M3,n)
  
!        write(6,*)"finishing MXM";call flush(6)                 

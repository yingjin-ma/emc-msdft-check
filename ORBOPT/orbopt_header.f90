...
!                         updated 2016 for Linear-response 
! =====================================================================
...
! 6) closed shell approximation                              (done and tesing)
...
print '(a/)',' and                                                                     '
print '(a//)',' DMRG state-averaged graadients (Hessian matrix part)                    '
print '(a )',' Main author:                                                            '
print '(a )',' ------------                                                            '
print '(a/)','             Y. Ma     (ETH Zurich and U Nanjing)                        '
...
print '(/a   )','                Zurich/Nanjing: 2009-2016                             '
print '(a/   )', ' -----------------------------------------------------------------------'

...
if(CMAKE_Fortran_COMPILER_ID MATCHES GNU) # this is gfortran
    ...
    set(CMAKE_Fortran_FLAGS_RELEASE " -cpp -fstack-arrays -finline-limit=2000 -O2 -w")
    set(CMAKE_Fortran_FLAGS_PROFILE "${CMAKE_Fortran_FLAGS_RELEASE} -pg")

elseif(CMAKE_Fortran_COMPILER_ID MATCHES Intel)
    set(CMAKE_Fortran_FLAGS         " -fpp -w -assume byterecl -DINTEL -g -traceback")
    set(CMAKE_Fortran_FLAGS_DEBUG   "-O0")
    set(CMAKE_Fortran_FLAGS_RELEASE "-O2 -ip")

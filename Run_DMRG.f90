...
! ====================================================================
          run1=""
          run1="~/Chem_soft/QCMaquis_feng/V1/applications/dmrg/dmrg_R"&
               //" "//trim(dmrg_input_name)//"_deri > "&
...
! ====================================================================
         ! Reset to follow the normal Davidson
          run1=""
          run1="~/Chem_soft/QCMaquis_feng/V1/applications/dmrg/dmrg_L"&
               //" "//trim(dmrg_input_name)//"_deri > "&
...
! ====================================================================
          ...
          run1=""
          run1="~/Chem_soft/QCMaquis_feng/V1/applications/dmrg/dmrg"&
...
! ====================================================================
              run1=""
              run1=&
            "~/Chem_soft/QCMaquis_feng/V1/applications/dmrg/dmrg_R"&
                   //" "//trim(dmrg_input_name)//"_deri > "&
                   //trim(dmrg_output_name)//"_deriR" 
              open(unit=200,file="run_dmrg_deriR")
                write(200,*)trim(run1)
...
! ====================================================================
             ! Reset to follow the normal Davidson
              run1=""
              run1=&
         "~/Chem_soft/QCMaquis_feng/V1/applications/dmrg/dmrg_L"&
                   //" "//trim(dmrg_input_name)//"_deri > "&
                   //trim(dmrg_output_name)//"_deriL" 
              open(unit=200,file="run_dmrg_deriL")
                write(200,*)trim(run1)
...
! If during sweeps
      ...
      Subroutine run_DMRG_direct(icycle)
        ...
        run3=''
          ...
          !run1="~/Chem_soft/QCMaquis_feng/V1/applications/dmrg/dmrg"&
        run1="~/Maquis_training/build/applications/dmrg/dmrg"&

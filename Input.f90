...
!        write(*,*)"start infile"
       ...
       inquire(file="infile.inp", exist=is_available)
...
! get the group table
!              write(*,*)"Before group table" not used yet
              call group_table() 
...
!              OPEN(23,FILE='ONETWOINT',form='unformatted')
!              do i1=1,norb
!              do i2=1,i1
!              do i3=1,norb
!              do i4=1,i3
!                 read(23)U(i1,i2,i3,i4)
!                 U(i2,i1,i3,i4)=U(i1,i2,i3,i4)
!                 U(i1,i2,i4,i3)=U(i1,i2,i3,i4)
!                 U(i2,i1,i4,i3)=U(i1,i2,i3,i4)
!              end do
!              end do
!              end do
!              end do
